import {initializeExpansion} from './expansion-combat.js?v=0.44.0';
import {settleVeterans} from './veterans.js?v=0.44.0';
import {recruitPrice} from './realm-buildings.js?v=0.44.0';
import {initializeRealmBattle} from './realm-combat.js?v=0.44.0';
import { reservedTroops } from './squads.js?v=0.44.0';
import { FIELD_RULES, casualtyQuote, initializeSignatures } from './fieldcraft.js?v=0.44.0';
import { claimSupply } from './supplies.js?v=0.44.0';
import { barracksCapacity, deployedTroops, troopShares, troopPower } from './logistics.js?v=0.44.0';
import { isExternal, externalInvitation } from './roster.js?v=0.44.0';
import { openAffair } from './affairs.js?v=0.44.0';
import { initializeStrategy } from './strategy.js?v=0.44.0';
import { initializeDoctrine } from './doctrines.js?v=0.44.0';
import { CORPS, corpsRank } from './development.js?v=0.44.0';
import { ARMS } from './martial.js?v=0.44.0';
import { hireHelper, helperBonus, validateHelpers } from './helpers.js?v=0.44.0';
import { finishDuty, developmentAction, raidBonus, RAID_INTEL, searchEquipment } from './camp-development.js?v=0.44.0';
