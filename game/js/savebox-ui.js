import { savedTime, importComparison } from './save-comparison.js?v=0.31.0';
import { emptySlot } from './slots.js?v=0.31.0';
import { slotNumber } from './portable.js?v=0.31.0';
import { icon } from './icons.js?v=0.31.0';
