import {validateExpansion} from './expansion-save.js?v=0.29.3';
import { validateRealm, validRealmContext } from './realm.js?v=0.29.3';
import { staminaCap } from './logistics.js?v=0.29.0';
import { migrateRoster, rosterVersion } from './roster.js?v=0.29.0';
import { validateAlliances } from './volume-four-data.js?v=0.29.0';
import { validEliteContext } from './elites.js?v=0.29.3';
import { validateDebrief } from './debrief.js?v=0.29.3';
import { validateAffairs } from './affairs.js?v=0.29.3';
import { validateStrategy } from './strategy.js?v=0.29.3';
import { validateCommands } from './commands.js?v=0.29.0';
import { validateFrontier, POSTS } from './frontier.js?v=0.29.0';
import { validateDevelopment } from './development.js?v=0.29.0';
import { validateCampaign, validRotationContext } from './rotations.js?v=0.29.3';
import { validateQualities } from './quality.js?v=0.29.0';
import { newGame } from './core.js?v=0.29.3';
import { hasOwn, idPattern, requireRule } from './utils.js?v=0.29.0';
import { migrateBattle, BATTLE_LIMIT_MS } from './battle.js?v=0.29.3';
import { validateGrowth } from './growth.js?v=0.29.0';
import { validateGrowthBattle } from './growth-save.js?v=0.29.0';
import { validateCamp, RAIDS } from './camp.js?v=0.29.3';
