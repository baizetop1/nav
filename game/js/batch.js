...
import { experienceToNext, experienceResult, ATTRIBUTE_NAMES } from './progression.js?v=0.20.0';
import { clone, journal, requireRule } from './utils.js?v=0.20.0';
import { itemAction } from './item.js?v=0.20.0';
import { growthAction } from './growth.js?v=0.20.0';
