import { parseSave } from './save.js?v=0.9.0';
...
const context = fields('type id next kind tier period');
...
const shape = {
  ...fields('version rosterVersion revision clock lastRegen rng worldMinute location startedAt team nextEquipment message formationPending battleSkillMode'),
  ...
  battle: {expedition:fields('troops tactic arm'),...fields('mode elapsed itemReadyAt guest outcome log rules martial'), team: [unit], enemy: [unit], context},
