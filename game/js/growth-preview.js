...
import { heroCommand, staminaCap } from './logistics.js?v=0.29.0';
import { ATTRIBUTE_NAMES } from './progression.js?v=0.29.0';
import { unlockReason } from './growth.js?v=0.29.0';
