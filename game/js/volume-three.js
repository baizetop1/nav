import { sixthEnemyList, applySixthPreparation } from './volume-six-data.js?v=0.44.0';
import { deployedTroops } from './logistics.js?v=0.44.0';
import { fifthEnemyList, applySiegePreparation } from './volume-five-data.js?v=0.44.0';
import { applyAllianceSupport } from './volume-four-data.js?v=0.44.0';
import { CHAPTER_MISSIONS } from './volume-three-data.js?v=0.44.0';
