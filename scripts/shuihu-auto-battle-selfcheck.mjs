...
const legacy=battleFixture();delete legacy.battle.rules;delete legacy.battle.roles;for(const u of legacy.battle.team)delete u.training;legacy.battle.round=3;delete legacy.battle.mode;delete legacy.battle.elapsed;delete legacy.battle.itemReadyAt;
