...
console.log('Shuihu focused UI: page isolation, relocated overview, recruit selection, collapsed secondary content, direct forge access, old-message suppression and save/error visibility passed.');
