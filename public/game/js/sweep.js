...
import { dispatch } from './core.js?v=0.32.0';
import { advanceBattle } from './battle.js?v=0.32.0';
import { dailyUses, rotationPlan, rotationCalendar } from './rotations.js?v=0.32.0';
