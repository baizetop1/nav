import {initializeExpansion} from './expansion-combat.js?v=0.29.3';
import {settleVeterans} from './veterans.js?v=0.29.0';
import {recruitPrice} from './realm-buildings.js?v=0.29.0';
import {initializeRealmBattle} from './realm-combat.js?v=0.29.3';
import { reservedTroops } from './squads.js?v=0.29.3';
import { FIELD_RULES, casualtyQuote, initializeSignatures } from './fieldcraft.js?v=0.29.0';
import { claimSupply } from './supplies.js?v=0.29.3';
...
import { openAffair } from './affairs.js?v=0.29.3';
import { initializeStrategy } from './strategy.js?v=0.29.3';
...
import { finishDuty, developmentAction, raidBonus, RAID_INTEL, searchEquipment } from './camp-development.js?v=0.29.3';
