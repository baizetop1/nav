import { recruitSupportPanel } from './recruit-support-ui.js?v=0.32.0';
import {CORPS} from './development.js?v=0.32.0';
import {pageSection,sectionNavigation} from './page-sections.js?v=0.32.0';
import { frontierMap } from './frontier-ui.js?v=0.32.0';
import {personalTaskPanel} from './expansion-ui.js?v=0.32.0';
import { retreatForecast } from './fieldcraft-ui.js?v=0.32.0';
import { volumeSixBoard, sixthMissionCard } from './volume-six-ui.js?v=0.32.0';
import {staminaPanel,inventoryPanel,recipePanel,provisionSources} from './provisions-ui.js?v=0.32.0';
import { staminaCap } from './logistics.js?v=0.32.0';
import { isExternal, isWanderer } from './roster.js?v=0.32.0';
import { fifthMissionCard, fifthLocalHelp, volumeFiveBoard } from './volume-five-ui.js?v=0.32.0';
import { fourthMissionCard, fourthLocalHelp, volumeFourBoard } from './volume-four-ui.js?v=0.32.0';
import { chapterMissionCard, thirdLocalHelp, volumeThreeBoard } from './volume-three-ui.js?v=0.32.0';
import { chroniclePanel } from './hero-chronicles.js?v=0.32.0';
import { progressionPanel, experienceLabel } from './progression-ui.js?v=0.32.0';
import { debriefPanel } from './sortie-ui.js?v=0.32.0';
import { batchButtons } from './batch-ui.js?v=0.32.0';
import { equipmentComparison } from './management-ui.js?v=0.32.0';
import { objectivePanel } from './strategy-ui.js?v=0.32.0';
import { ordersPanel, equipmentFilters, recruitBatchDialog } from './commands-ui.js?v=0.32.0';
import { equipmentMatches } from './commands.js?v=0.32.0';
import { corpsPanel, presetsPanel, targetPanel, setPanel, setsCatalog } from './development-ui.js?v=0.32.0';
import {talentPanel} from './talents.js?v=0.32.0';
import { realmPanel } from './realm-ui.js?v=0.32.0';
import { rotationsPage } from './rotations-ui.js?v=0.32.0';
import { traitCard } from './martial-ui.js?v=0.32.0';
import { helpersBoard } from './helpers-ui.js?v=0.32.0';
import { rosterBoard, qualityPanel, qualityTrials, invitation } from './roster-ui.js?v=0.32.0';
import { qualityOf, QUALITIES } from './quality.js?v=0.32.0';
import { worldMap, localBenefit } from './world-map-ui.js?v=0.32.0';
import { saveBoxPage } from './savebox-ui.js?v=0.32.0';
import { attributes } from './hero.js?v=0.32.0';
import { exits, meets, heroRank, dungeonEntry } from './map.js?v=0.32.0';
import { isBusy, questReady } from './core.js?v=0.32.0';
import { statusName, skillReason, battleItemQuote, enemySkill, BATTLE_ITEMS, battleSkillMode } from './battle.js?v=0.32.0';
import { strengthenQuote } from './item.js?v=0.32.0';
import { icon, actionIcon } from './icons.js?v=0.32.0';
import { heroStewardCard } from './camp-development-ui.js?v=0.32.0';
import { heroGrowth, growthSources, stableMounts, dungeonMountLoot } from './growth-ui.js?v=0.32.0';
import { campPage, portrait } from './camp-ui.js?v=0.32.0';
...
export function render({state:s,data:d,view,status='',error='',locked=false,notice='',recruitTarget='',entered=true,battlePaused=false,battlePauseReason='',saveBox={},activity=null,battleSpeed=.5,mapTarget=null,mapSection='story',pageSections={},roster={},leaderboard={},gear={}}){
  ...
  let content=screen==='realm'?realmPanel(s,d,esc,btn,pageSections.realm):screen==='trials'?rotationsPage(s,d,esc,btn,leaderboard):screen==='camp'?campPage(s,d,esc,btn):screen==='save'?saveBoxPage(s,status,locked,saveBox):screen==='chronicle'?chroniclePage(s,d):screen==='battle'?battlePage(s,d,battlePaused,battlePauseReason,locked,battleSpeed):screen==='scheme'?schemePage(s,d):screen==='event'?eventPage(s,d):screen==='heroes'?heroesPage(s,d,roster,pageSections.heroes):screen==='bag'?bagPage(s,d,gear,pageSections.bag):screen==='forge'?forgePage(s,d,gear):screen==='recruit'?recruitPage(s,d,recruitTarget,roster):screen==='quests'?questsPage(s,d):mapPage(s,d,mapTarget,mapSection);
