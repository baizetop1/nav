import { hasFifthVolume } from './volume-five-data.js?v=0.24.0';
import { hasFourthVolume } from './volume-four-data.js?v=0.24.0';
import { hasThirdVolume } from './volume-three.js?v=0.24.0';
import { gameSnapshot, slotId, slotName } from './portable.js?v=0.24.0';
