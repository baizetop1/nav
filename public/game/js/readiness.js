...
import { corpsQuote, targetQuote } from './development.js?v=0.20.0';
import { skillUpgradeQuote } from './growth.js?v=0.20.0';
import { chronicleQuote } from './hero-chronicles.js?v=0.20.0';
import { ELITES, elitePlan } from './elites.js?v=0.20.0';
